const {userExceptions, activationCodeExceptions} = require("../../../domain/identity/exceptions");
const {
    userRepository,
    activationCodeRepository,
    activationTokenRepository,
    accessTokenRepository
} = require("../../../infrastracture/repositories/identity");
...
const register = async credentials => {
    ...
    await characterRepository.create({UserId: user.id});
    return user;
};
